    ...
    <div style={{ animation: 'fadeIn 0.3s ease', maxWidth: '900px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <div>
          ...
          <p style={{ margin: 0, color: '#475569', fontSize: '0.9rem' }}>Fidelizza i tuoi clienti e aumenta le prenotazioni.</p>
        </div>
        <button style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 16px', borderRadius: '8px', border: 'none', backgroundColor: '#2563eb', color: '#0f172a', fontWeight: '600', cursor: 'pointer' }}>
          <Plus size={18} />
          Nuova Campagna
        </button>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '32px' }}>
        <div style={{ backgroundColor: '#ffffff', backdropFilter: 'blur(20px)', borderRadius: '16px', padding: '24px', boxShadow: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', border: '1px solid transparent', transition: 'border 0.2s', cursor: 'pointer' }} onMouseEnter={e => e.currentTarget.style.borderColor = '#2563eb'} onMouseLeave={e => e.currentTarget.style.borderColor = 'transparent'}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#475569', margin: 0 }}>Invia comunicazioni rapide ai tuoi clienti per promozioni last-minute.</p>
        </div>
        ...
        <div style={{ backgroundColor: '#ffffff', backdropFilter: 'blur(20px)', borderRadius: '16px', padding: '24px', boxShadow: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', border: '1px solid transparent', transition: 'border 0.2s', cursor: 'pointer' }} onMouseEnter={e => e.currentTarget.style.borderColor = '#2563eb'} onMouseLeave={e => e.currentTarget.style.borderColor = 'transparent'}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#475569', margin: 0 }}>Newsletter mensili, auguri di compleanno e comunicazioni lunghe.</p>
        </div>
        ...
        <div style={{ backgroundColor: '#ffffff', backdropFilter: 'blur(20px)', borderRadius: '16px', padding: '24px', boxShadow: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', border: '1px solid transparent', transition: 'border 0.2s', cursor: 'pointer' }} onMouseEnter={e => e.currentTarget.style.borderColor = '#2563eb'} onMouseLeave={e => e.currentTarget.style.borderColor = 'transparent'}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#475569', margin: 0 }}>Crea coupon per incentivare la prenotazione online nei periodi calmi.</p>
        </div>
      </div>
